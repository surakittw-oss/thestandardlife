	...
	<article <?php post_class(); ?>>
		...
		<header class="art-head">
			...
			<div class="art-share">
				...
				<a href="https://social-plugins.line.me/lineit/share?url=<?php echo $url_enc; ?>" target="_blank" rel="noopener noreferrer" aria-label="LINE"><svg viewBox="0 0 24 24"><path d="M24 10.3C24 4.93 18.62.56 12 .56S0 4.93 0 10.3c0 4.81 4.27 8.84 10.03 9.6.39.08.92.26 1.06.6.12.3.08.78.04 1.09l-.17 1.03c-.05.3-.24 1.19 1.04.65 1.28-.54 6.9-4.06 9.42-6.96C22.98 14.4 24 12.5 24 10.3Z"/></svg></a>
				<a href="#" onclick="navigator.clipboard&&navigator.clipboard.writeText('<?php echo esc_js( $permalink ); ?>');return false;" aria-label="<?php esc_attr_e( 'Copy link', 'thestandard-life' ); ?>"><svg viewBox="0 0 24 24"><path d="M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1M8 13h8v-2H8zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.76 0 5-2.24 5-5s-2.24-5-5-5z"/></svg></a>
			</div>
		</header>
