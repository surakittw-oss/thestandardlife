<?php
/**
 * LIFE page footer shell. Included via tsl_get_footer().
 *
...
<footer>
	<div class="foot-top">
		<div class="foot-brand">
			<div class="logo-lg">
				<img src="<?php echo esc_url( TSL_URL . 'assets/img/logo-tsl.png' ); ?>" alt="THE STANDARD LIFE" style="height:60px; width:auto; filter:invert(1);">
			</div>
			<p><?php esc_html_e( 'คู่มือกิน ดื่ม เที่ยว และ Well-being ของคนเมืองที่อยากมีสุขภาพกายและใจที่ดีอย่างยั่งยืน — The Urban Guide to Well-being', 'thestandard-life' ); ?></p>
			<div class="socials">
		...
		<div>
			<h5><?php esc_html_e( 'THE STANDARD', 'thestandard-life' ); ?></h5>
			<ul>
				<li><a href="https://thestandard.co/" target="_blank" rel="noopener">THE STANDARD</a></li>
				<li><a href="https://thestandard.co/wealth/" target="_blank" rel="noopener">THE STANDARD WEALTH</a></li>
				<li><a href="https://thestandard.co/sport/" target="_blank" rel="noopener">THE STANDARD SPORT</a></li>
				<li><a href="https://thestandard.co/pop/" target="_blank" rel="noopener">THE STANDARD POP</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="foot-bottom">
		...
		<div class="l">
			...
			<a href="<?php echo esc_url( get_post_type_archive_link( TSL_CPT ) ); ?>"><?php esc_html_e( 'LIFE', 'thestandard-life' ); ?></a>
		</div>
	</div>
</footer>
